    ...
    <div class="page-container">
      ...
      @else {
        <table mat-table [dataSource]="items()" class="full-width">
          ...
          <ng-container matColumnDef="studentsCount"><th mat-header-cell *matHeaderCellDef>O'quvchilar</th><td mat-cell *matCellDef="let e">{{e.studentsCount}}</td></ng-container>
