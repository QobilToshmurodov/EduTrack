...
namespace EduTrack.Infrastructure.Migrations
{
    ...
    public partial class InitialMigrationV2 : Migration
    {
        ...
        {
            migrationBuilder.Sql("DROP TABLE IF EXISTS \"Grades\", \"NotificationLogs\", \"TeacherSubjectGroups\", \"Submissions\", \"AttendanceEvents\", \"Parents\", \"Assignments\", \"Students\", \"Subjects\", \"Teachers\", \"Groups\", \"Users\" CASCADE;");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedStudentId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Parents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Parents_Students_LinkedStudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttendanceEvents_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherSubjectGroups", x => new { x.TeacherId, x.SubjectId, x.GroupId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationLogs_AttendanceEvents_EventId",
                        column: x => x.EventId,
                        principalTable: "AttendanceEvents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotificationLogs_Parents_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceEvents_TeacherId",
                table: "AttendanceEvents",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationLogs_ParentId",
                table: "NotificationLogs",
                column: "ParentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Parents_LinkedStudentId",
                table: "Parents",
