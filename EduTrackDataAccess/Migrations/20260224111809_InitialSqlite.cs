    ...
    public partial class InitialSqlite : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeSubjectGroups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeSubjectGroups_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeSubjectGroups_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeSubjectGroups_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "$2a$11$3GBDkgwYeD2hg3Av4Pq1JO9gMX/4EpmGvU1Ga.H7.9jsAiptNREoa", "Admin", "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSubjectGroups_EmployeeId_SubjectId_GroupId",
                table: "EmployeeSubjectGroups",
                columns: new[] { "EmployeeId", "SubjectId", "GroupId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSubjectGroups_GroupId",
                table: "EmployeeSubjectGroups",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSubjectGroups_SubjectId",
                table: "EmployeeSubjectGroups",
                column: "SubjectId");
